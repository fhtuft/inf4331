...
# Nice use of docstrings. Not too much, giving a 
# sufficient description of function and correponding arguments.

def _plot_me(func,func_id):
    """
        Helper funcion. 

        Calls the correct plotter function
...
def plot_temperature(month,start_time, end_time,y_min,y_max):
    """
        ...
        Args:
            ...
            y_min: minimum value for temperature to show in plot
            y_max: maximum value for temperature to show in plot
    """
...
def plot_CO2(start_time, end_time,y_min,y_max):
    """
        Plots CO2
        Args:
            start_time: year to start plotting from
            end_time: year to end plotting from
...
if __name__ == '__main__':
    ...
    # For me it seems more natural to have the minimum and minimum 
    # axes as default values. In particular for the co2 and temperature 
